            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 relative z-10">
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] text-gray-600 font-bold uppercase tracking-tighter">Update setiap 60d</span>
                    </div>
                ...
                <div className="flex-none w-full lg:w-auto flex items-stretch gap-3">
                    ...
                    <div className="flex-1 lg:flex-none flex flex-col justify-between bg-gray-800/40 p-3 lg:p-4 rounded-xl border border-gray-700/30 min-w-[140px]">
                        ...
                        <div className="h-1 w-full bg-gray-700/50 rounded-full overflow-hidden flex">
                            <div className="h-full bg-green-500" style={{ width: `${(upCount / totalCoins) * 100}%` }}></div>
                            <div className="h-full bg-yellow-500" style={{ width: `${(stableCount / totalCoins) * 100}%` }}></div>
                            <div className="h-full bg-red-500" style={{ width: `${(downCount / totalCoins) * 100}%` }}></div>
                        </div>
                    </div>
